...
<script setup>
const subPages = [
  // Traditional ScholarsModern ScholarsForeign Scholars
  {
...
let activeButton = ref("Traditional Scholars");

// get active button from route
onMounted(() => {
  ...
  if (routepage == "modern-scholars") {
    ...
    activeButton.value = "Traditional Scholars";
  }
});
</script>
